package com.martens.hackatonV2.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .cors().and().csrf().disable() // Disable CSRF. Leaving it enabled would ignore GET, HEAD, TRACE, OPTIONS
                ...
                .antMatchers(POST,"/activity/add-participant", "/housing/add-resident").hasRole("ADMIN")
